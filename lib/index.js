...
const { TagAnalyzer, PRESERVED_TAGS } = require('./tag-analyzer');
...
module.exports = {
  ...
  // Tag Analysis (AI-powered)
  TagAnalyzer,
  PRESERVED_TAGS,

  // Claude API client
  ClaudeClient: claudeApi.ClaudeClient,
  checkClaudeConfig: claudeApi.checkClaudeConfig,
  saveClaudeApiKey: claudeApi.saveClaudeApiKey,
  removeClaudeApiKey: claudeApi.removeClaudeApiKey
};
